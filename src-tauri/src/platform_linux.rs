...
pub mod volume {
    ...
    pub fn get_volume() -> Result<u8> {
        ...
        let volume = selem.get_playback_volume(alsa::mixer::SelemChannelId::FrontLeft)
    ...
    pub fn set_volume(level: u8) -> Result<()> {
        ...
        selem.set_playback_volume_all(val)
            .map_err(|e| AppError::Platform(e.to_string()))?;
    ...
    pub fn is_muted() -> Result<bool> {
        ...
        let switch = selem.get_playback_switch(alsa::mixer::SelemChannelId::FrontLeft)
            .map_err(|e| AppError::Platform(e.to_string()))?;
    ...
    pub fn set_mute(mute: bool) -> Result<()> {
        ...
        selem.set_playback_switch_all(switch)
            .map_err(|e| AppError::Platform(e.to_string()))?;
...
pub mod media {
    ...
    pub fn pause_all() -> Result<()> {
        ...
        let dbus = zbus::blocking::fdo::DBusProxy::new(&conn).map_err(|e| AppError::Platform(e.to_string()))?;
        let names = dbus.list_names().map_err(|e| AppError::Platform(e.to_string()))?;
