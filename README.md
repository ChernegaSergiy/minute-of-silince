...
[Screenshots](#screenshots) · [Features](#features) · [Audio Presets](#audio-presets) · [Installation](#installation) · [Building](#building-from-source) · [Contributing](#contributing)
...
```bash
# Debian package
sudo dpkg -i minute-of-silence_0.10.2_amd64.deb

# AppImage
chmod +x minute-of-silence_0.10.2_amd64.AppImage
./minute-of-silence_0.10.2_amd64.AppImage
```
